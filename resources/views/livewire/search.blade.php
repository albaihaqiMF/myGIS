...
<div class="intro-x relative mr-3 sm:mr-6">
    ...
    <div class="search-result">
        <div class="search-result__content">
            <div class="search-result__content__title">Pages {{ $query }}</div>
            <div class="mb-5">
            ...
            <div class="mb-5">
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="MyGIS Tailwind HTML Admin Template" class="rounded-full" src="/images/profile-12.jpg">
                    </div>
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="MyGIS Tailwind HTML Admin Template" class="rounded-full" src="/images/profile-7.jpg">
                    </div>
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="MyGIS Tailwind HTML Admin Template" class="rounded-full" src="/images/profile-10.jpg">
                    </div>
                ...
                <a href="" class="flex items-center mt-2">
                    <div class="w-8 h-8 image-fit">
                        <img alt="MyGIS Tailwind HTML Admin Template" class="rounded-full" src="/images/profile-4.jpg">
                    </div>
            ...
            <a href="" class="flex items-center mt-2">
                <div class="w-8 h-8 image-fit">
                    <img alt="MyGIS Tailwind HTML Admin Template" class="rounded-full" src="/images/preview-13.jpg">
                </div>
            ...
            <a href="" class="flex items-center mt-2">
                <div class="w-8 h-8 image-fit">
                    <img alt="MyGIS Tailwind HTML Admin Template" class="rounded-full" src="/images/preview-6.jpg">
                </div>
            ...
            <a href="" class="flex items-center mt-2">
                <div class="w-8 h-8 image-fit">
                    <img alt="MyGIS Tailwind HTML Admin Template" class="rounded-full" src="/images/preview-14.jpg">
                </div>
