...
<div class="grid w-full grid-cols-12 gap-3">
    ...
    <div class="col-span-12 overflow-auto intro-y lg:overflow-visible">
        <div class="flex flex-wrap items-center justify-between col-span-12 mt-2 intro-y sm:flex-nowrap">
            <a href="{{ route('map.create') }}" class="mr-2 shadow-md btn btn-primary">
                <span>
                    ...
                    <tr class="intro-x">
                        ...
                        <td>
                            <div class="flex justify-center w-20">
                                <img src="{{ $item->getTaksasi() }}" class="object-cover w-12 h-12 rounded-full zoom-in"
                                    alt="{{ $item->getTaksasi() }}">
                            </div>
                        </td>
                        <td>
                            <div class="flex justify-center w-20">
                                <img src="{{ $item->getNdvi() }}" class="object-cover w-12 h-12 rounded-full zoom-in"
                                    alt="{{ $item->getNdvi() }}">
                            </div>
                        </td>
