            ...
            <form action="{{ route('map.store') }}" enctype="multipart/form-data" method="POST" class="px-4 py-6 box">
                ...
                <div class="mb-3">
                    ...
                    <input id="gambar_taksasi" name="gambar_taksasi" type="file" accept="image/*"
                        class="w-full transition cursor-pointer form-control file:bg-indigo-50 file:hover:bg-indigo-100 file:rounded-full file:px-3 file:py-1 file:border-none file:text-indigo-800 file:duration-300" placeholder="Taksasi">
                </div>
                <div class="mb-3">
                    ...
                    <input id="gambar_ndvi" name="gambar_ndvi" type="file" accept="image/*" class="w-full transition cursor-pointer form-control file:bg-indigo-50 file:hover:bg-indigo-100 file:rounded-full file:px-3 file:py-1 file:border-none file:text-indigo-800 file:duration-300"
                        placeholder="NDVI">
                </div>
